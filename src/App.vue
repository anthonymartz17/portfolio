	...
	<div id="app">
		...
		<div class="container">
			...
			<header>
				...
				>
					<h1 class="my-huge-name" v-show="!$store.state.showName">
						Antonio Martinez
					</h1>
				</transition>
			</header>
			...
			<main>
				<transition appear name="router-animation">
					<routerView />
				</transition>
			</main>
...
.toggleIt-enter-active,
.toggleIt-leave-active {
